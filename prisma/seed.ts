...
const basicWeapons = [
  ...
  { name: 'Stone Hammer', description: 'A heavy hammer with a stone head.', category: 'Hammer', baseDamage: calcDamage('Greathammer'), attackSpeed: 0.5, weight: 10, strRequired: 10, dexRequired: 0, intRequired: 0 }, // Hammer -> Greathammer
